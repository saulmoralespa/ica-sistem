...
var mLayout = function() {
    ...
    return {
        ...
        initAside: function() {
            var a, n, o, i, l;
            a = mUtil.get("m_aside_left"), n = mUtil.hasClass(a, "m-aside-left--offcanvas-default") ? "m-aside-left--offcanvas-default" : "m-aside-left", e = new mOffcanvas("m_aside_left", {
                baseClass: n,
                overlay: !0,
            ...
            }), i = mUtil.get("m_ver_menu"), l = "1" === mUtil.attr(i, "m-menu-dropdown") ? "dropdown" : "accordion", "1" === mUtil.attr(i, "m-menu-scrollable") && (o = {
                height: function() {
